...
def put_data(file, variables, header='', fmt='', append='no'):
...
def put_2Darray(file, array, header='', fmt='', append='no'):
    ...
    lista = tuple(lista)
    put_data(file, lista, header, fmt, append)
